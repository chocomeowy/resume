...
const experiences = [
  {
    ...
    description: "Architected high-volume data pipelines for real-time solar asset monitoring, building the capacity to handle FinTech-scale datasets.",
    highlights: [
      "Scaled IoT monitoring from 40 to 500+ devices using PostgreSQL and Grafana.",
      "Managed large-scale data pipelines to reduce incident detection time to < 1 hour.",
      "Optimized database performance for consistent, low-latency data visualization.",
    ],
    icon: <Monitor className="h-6 w-6" />,
    skills: ["PostgreSQL", "Data Pipelines", "Grafana", "Python"],
  },
  {
    title: "Application Engineer (Contract)",
    company: "Nityo Infotech / DBS Singapore",
    period: "Jan 2023 – Sep 2023",
    description: "Developed robust technical architecture and internal web interfaces for banking service health monitoring.",
    highlights: [
      "Built resilient internal dashboards using ReactJS and Material-UI.",
      "Implemented automated service health monitoring systems for core banking infrastructure.",
      "Ensured high availability and system stability through robust architectural patterns.",
    ],
    icon: <Activity className="h-6 w-6" />,
    skills: ["Technical Architecture", "ReactJS", "Service Monitoring"],
  },
  {
    title: "Application Engineer",
    company: "Sentient.io",
    period: "Dec 2021 – Dec 2022",
    description: "Designed and implemented AI microservices and scalable full-stack architectures.",
    highlights: [
      "Built AI recommendation engine for Toyota using modular microservices.",
      "Developed 'ScribeRabbit' (VueJS/FastAPI), ensuring scalable backend performance.",
      "Architected secure and performant API layers for diverse AI applications.",
    ],
    icon: <Cpu className="h-6 w-6" />,
    skills: ["AI Microservices", "FastAPI", "Scalable Systems"],
  },
  {
    title: "Business Support Analyst / Operation Analyst",
    company: "Apple South Asia",
    period: "Aug 2015 – May 2021",
    description: "Applied BSc Business foundation to manage regional operational logic and KPI reporting.",
    highlights: [
      "Leveraged business degree to optimize regional order fulfillment logic.",
      "Developed automated operational dashboards using SAP and advanced Excel.",
      "Conducted UAT for internal logistics software, ensuring alignment with business goals.",
    ],
    icon: <Briefcase className="h-6 w-6" />,
    skills: ["Operational Logic", "KPI Reporting", "SAP", "BSc Business"],
  },
]
