...
const connectLinks = [
  {
    ...
    glow: "hover:shadow-[0_0_30px_rgba(110,84,148,0.25)] hover:border-purple-400/40",
    iconColor: "text-purple-400 bg-purple-400/10 border-purple-400/20 group-hover:bg-purple-400/20",
    icon: (
  ...
  },
  {
    ...
    glow: "hover:shadow-[0_0_30px_rgba(10,102,194,0.25)] hover:border-blue-400/40",
    iconColor: "text-blue-400 bg-blue-400/10 border-blue-400/20 group-hover:bg-blue-400/20",
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    iconColor: "text-sky-400 bg-sky-400/10 border-sky-400/20 group-hover:bg-sky-400/20",
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    glow: "hover:shadow-[0_0_30px_rgba(37,211,102,0.2)] hover:border-emerald-400/40",
    iconColor: "text-emerald-400 bg-emerald-400/10 border-emerald-400/20 group-hover:bg-emerald-400/20",
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
  ...
  return (
    <div className="space-y-16">
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <Button
          variant="outline"
          className="rounded-full px-8 py-6 border-border/60 hover:bg-accent/5 hover:border-accent/40 text-sm font-semibold transition-all hover:scale-[1.02] active:scale-95 h-auto"
          onClick={copyEmail}
        >
          {copied ? (
            <>
              <svg className="w-4 h-4 mr-2 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
